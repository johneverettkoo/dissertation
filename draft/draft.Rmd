...
### Likelihood Maximization Approaches to Block Models

\newpage

# Random Dot Product Graphs and Generalized Random Dot Product Graphs

## Connecting the Stochastic Block Model and the Degree Corrected Block Model to the Generalized Random Dot Product Graph
