...
2. Popularity Adjusted Block Model
    ...
    b. Subspace Clustering for Community Detection
    c. Orthogonal Spectral Clustering
...
If $x_i^\top$ and $x_j^\top$ are two rows of $X U$ corresponding 
...
**Algorithm**: Sparse Subspace Clustering:
...
5. Explore the performance of these techniques in the presence of outliers. 
