...
\begin{enumerate}
  \item $p^{(s)} \leftarrow (T^\top T)^{-1} T^\top X$, 
where $T = \begin{bmatrix} \tilde{t}_1 & \cdots & \tilde{t}_n \end{bmatrix}^\top$ and 
$X = \begin{bmatrix} x_1 & \cdots & x_n \end{bmatrix}^\top$.
  \item $t_i^{(s)} \leftarrow \arg\min_t \|x_i - p^\top \tilde{t}_i\|^2$
\end{enumerate}
\end{theorem}
