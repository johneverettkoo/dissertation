...
Common methods for Bezier curve fitting do not require specification of $t_1, ..., t_n$. However, an ordering is required. The curve fitting method is then modified as follows:
